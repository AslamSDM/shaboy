...
const sysprompt = `You are a game suggesting assistant. I will give you descriptions on a few games I own, and what emotion am I feeling now. You will have to suggest a game that fits my mood.
...
export function promptgen(ownedgames: any[], emotion: string) {
  ...
  for (const game of ownedgames) {
    prompt += `Game: ${game.name}, Description: ${game.description}`
  }
  prompt += `
