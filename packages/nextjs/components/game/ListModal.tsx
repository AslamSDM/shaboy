        ...
        <dialog id="list-now-modal" className="modal">
            <div className="shabow-plus-content modal-box flex flex-col items-center">
                ...
                <div className="flex flex-col w-full max-w-[80%] mt-[30px]">
                    ...
                    <input className="p-[10px] rounded-[5px] bg-[#ffffffed] text-[#000]" id="list-price" type="text" placeholder="0.002 ETH" onClick={(e) => { const target = e.target as HTMLInputElement; setPrice(Number(target.value)); }} />
                </div>
